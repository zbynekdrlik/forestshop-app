...
- Eshop → Výmena tovaru / Vrátený tovar / Reklamácie (#290/#514/#516 — READ-ONLY sekcie nad order.status_name, výpis+badge zdieľajú jeden predikát (exchange aj returned = počet aktívnych, nie unresolved-filtrovaný), väzba „nevybavené" na vratenie karty) → `.claude/rules/order-flags.md`
