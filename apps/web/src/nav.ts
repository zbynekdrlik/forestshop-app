...
import { FloorNotesSection } from "./components/FloorNotesSection.js";
...
export const NAV: readonly NavFolder[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      // issue 345 pôvodne pridalo READ-ONLY zoznam objednávok s dopravou
      // "Osobný odber". Issue 410 (šéfov kolega Štěpán, Discord 13.8.2026)
      // ho nahradilo vlastnými zápismi z predajne (Shoptet väzba zrušená) —
      // `id`/`label`/miesto v menu OSTÁVAJÚ nezmenené (mení sa len obsah
      // obrazovky), hneď za "Na objednanie" — obe sú "zoznam objednávok"
